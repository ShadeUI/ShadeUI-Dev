...
describe('RoundBanner', () => {
  ...
  it('applies neutral color to link when variant is fill', () => {
    render(<RoundBanner label="Fill Link Test" variant="fill" color="orange" showLinkButton />);
  ...
  it('applies matching color to link when variant is accent', () => {
    render(<RoundBanner label="Accent Link Test" variant="accent" color="purple" showLinkButton />);
    const link = screen.getByText('Learn more');
