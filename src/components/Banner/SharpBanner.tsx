...
export function SharpBanner({
  ...
  ...props
    ...
    const variantClasses: Record<Variant, string> = {
        accent:"text-[var(--shadeui-color-black-100)] dark:text-[var(--shadeui-color-white-80)] h-11 border-b",
        fill:"text-[var(--shadeui-color-white-100)] dark:text-[var(--shadeui-color-white-80)] h-11"
    }
    ...
    const colorClasses:  Record<Variant, Record<Color, string>>= {
        accent:{
        slate:` bg-[var(--shadeui-color-slate-25)]  border-b-[var(--shadeui-color-slate-200)]  
                dark:bg-[var(--shadeui-color-slate-800)] dark:border-b-[var(--shadeui-color-slate-900)]`, 
        blue:` bg-[var(--shadeui-color-blue-25)] border-b-[var(--shadeui-color-blue-100)] 
                dark:bg-[var(--shadeui-color-blue-800)] dark:border-b-[var(--shadeui-color-blue-900)]   `,
        gray:` bg-[var(--shadeui-color-gray-25)] border-b-[var(--shadeui-color-gray-100)] 
                dark:bg-[var(--shadeui-color-gray-800)] dark:border-b-[var(--shadeui-color-gray-900)]  `,
        orange:`bg-[var(--shadeui-color-orange-25)] border-b-[var(--shadeui-color-orange-100)] 
                dark:bg-[var(--shadeui-color-orange-600)] dark:border-b-[var(--shadeui-color-orange-800)]  `,
        purple:`bg-[var(--shadeui-color-purple-25)] border-b-[var(--shadeui-color-purple-100)]
                dark:bg-[var(--shadeui-color-purple-800)] dark:border-b-[var(--shadeui-color-purple-900)]  `,
        zinc:`bg-[var(--shadeui-color-zinc-25)] border-b-[var(--shadeui-color-zinc-100)] 
            dark:bg-[var(--shadeui-color-zinc-800)] dark:border-b-[var(--shadeui-color-zinc-900)]  `,
        } , 
    ...
    const sharpBannerClassNames = cn(
        baseStyles,
  ...
  return (
    <div className={sharpBannerClassNames}>
